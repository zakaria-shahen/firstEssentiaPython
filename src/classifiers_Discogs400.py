...
embedding_model = TensorflowPredictEffnetDiscogs(graphFilename="../model/discogs-effnet-bs64-1.pb", output="PartitionedCall:1")

embeddings = embedding_model(audio)

model = TensorflowPredict2D(graphFilename="../model/genre_discogs400-discogs-effnet-1.pb", input="serving_default_model_Placeholder", output="PartitionedCall:0")
...
with open('../model/genre_discogs400-discogs-effnet-1.json', 'r') as json_file:
